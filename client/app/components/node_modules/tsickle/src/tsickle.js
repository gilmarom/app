...
var ClosureRewriter = (function (_super) {
    ...
    ClosureRewriter.prototype.maybeAddHeritageClauses = function (docTags, decl) {
        ...
        for (var _i = 0, _a = decl.heritageClauses; _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = heritage.types; _b < _c.length; _b++) {
                ...
                docTags.push({ tagName: tagName, type: alias || impl.getText() });
            }
        }
    };
    ...
    ClosureRewriter.prototype.newTypeTranslator = function (context) {
        var _this = this;
        var translator = new typeTranslator.TypeTranslator(this.program.getTypeChecker(), context, this.options.typeBlackListPaths, this.symbolsToAliasedNames);
...
var Annotator = (function (_super) {
    ...
    Annotator.prototype.emitTypeDefExports = function (exports) {
        ...
        for (var _i = 0, exports_2 = exports; _i < exports_2.length; _i++) {
            ...
            if (exp.sym.flags & ts.SymbolFlags.Alias)
                exp.sym = typeChecker.getAliasedSymbol(exp.sym);
    ...
    Annotator.prototype.getNamedSymbols = function (specifiers, typeChecker) {
